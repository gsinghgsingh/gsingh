   ...
   //       $temp2 = $temp['children'][1];
    //      $temp3 = $temp2['children'][0]['children'][0]['children'][58]['children'][2]['children'];
	 ...
	 // echo html_to_obj($response);
		...
		$response_row1 = $response_xpath->query("//a[contains(@class, 'fileOwner')]");// | //a[contains(@href, '4shared.com/img/')] | //a[contains(@href, '4shared.com/u/')] | //a[contains(@href, '4shared.com/folder/')] | //td[@class='tdC']/img[@src]");
