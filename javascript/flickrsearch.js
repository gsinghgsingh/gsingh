...
//Begin scrape function    
   ...
   $( "div.button input" ).click(function() {
      ...
      var tags = $("div.tags input").val();
      var url = "../pr.php?https://api.flickr.com/services/rest/?method=flickr.photos.search&api_key=6bf52f197b492b2b6bfe860161eeafde&format=json&nojsoncallback=1";
